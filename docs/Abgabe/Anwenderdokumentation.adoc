...
Um das Mitglied zu bearbeiten, muss man wie gehabt das *Bearbeitungs-Ico*n am Ende der Zeile auswählen. Folglich öffnet sich die Eingabemaske, in der Informationen geändert oder ergänzt werden können.
