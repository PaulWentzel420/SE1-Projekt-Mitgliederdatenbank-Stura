...
|===
|  | Amt | Berechtigung | Vorname | Nachname
| 1| Service/Buchhaltung (Angestellte) | Zugang: Schleuse; Schlüssel4 | |
| 2| Mitglied Ausschuss Finanzielles (Ausschüsse des StuRa)| Zugang: Schleuse; Schlüssel5; Schlüssel6 | |
| 3| Leitung Beauftragung Datenschutz (Beauftragte des StuRa)| Zugang: Schleuse; Schlüssel8 | |
| 4| studentische Vertretung (Beitrag Projekt eCampus)| Zugang: Schleuse; | |
| 5| SprecherIn Sprecherinnen und Sprecher (Fachausschuss Bauingenieurswesen/Architektur)| Zugang: Schleuse; | |
| 6| SprecherIn Sprecherinnen und Sprecher (Fachausschuss Design)| Zugang: Schleuse; | |
|===
