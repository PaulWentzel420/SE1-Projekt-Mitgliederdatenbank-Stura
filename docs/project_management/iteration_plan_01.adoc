...
* Team aufbauen, Rollen zuordnen, Stakeholder involvieren
* Systemfokus finden: Grenzen, Akteure, Schnittstellen
* Zentrale Projektrisiken identifizieren
* Kosten-Nutzen-Analyse („Rechtfertigung“)
* Einrichtung der Projektumgebung, Git, IDE, Testsystem…
