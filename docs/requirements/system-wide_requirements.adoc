...
Die Website benötigt keine 99,99% Erreichbarkeit, sollte jedoch so oft wie möglich verfügbar sein. Die Benutzereingaben sind auf Sinnhaftigkeit zu überprüfen um Falscheingaben zu verhindern (z.B. keine Postleitzahl im Namensfeld).
